...
function ContactUs() {
  ...
  return (
    <main>
        ...
        <div id="top1">
        <div id="p">
            <h2>DO YOU HAVE SOMETHING YOU WANT <br />TO TALK TO US ABOUT?</h2>
            <h3>Give us a ring, send us an email or fill out that nifty form below.</h3>
        </div>
        <form onSubmit={handelSubmit} method='post'>
          <div class="mb-3">
            <input type="name" onChange={changeHandler} name='name' placeholder='Name' class="form-control" id="exampleInputName1" aria-describedby="namelHelp"/>
        ...
        <div id="fadd">
            <div className="address">
                ...
                <p>Telephone: +91 22 61013800/18 | Email: support@tradefisher.in | © Copyright 2021 Trade Fisher Research Pvt. Ltd. All Rights Reserved. | GSTIN : 27BBDCE9006E1ZV</p>
          ...
          <div id="fadd">
            <div className="address">
              <h2>Gurgaon Office</h2>
                <p>Address: Trade Fisher Research Private Limited, Marathon Futurex, A-603 6th Floor, Mafatlal Mills Compound, N M Joshi Marg, South West Delhi, Gurgaon 110037</p>
                <p>Email: support@tradefisher.in | © Copyright 2021 Trade Fisher Research Pvt. Ltd. All Rights Reserved. | GSTIN : 27BBDCE9006E1ZV</p>
                {/* <p>Principal Officer: Manish Goel, Email: manish@equentis.com, +91 22 61013800</p> */}
            </div>
            <div className="address">
              <h2>Gujrat Office</h2>
