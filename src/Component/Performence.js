...
function Performence() {
  ...
  const handelSubmit=(e)=>{
    ...
    console.log(title);
    const box=title.map((l,index)=>{
        return(
        <div className="box">
            <img src={l.image} width={500} alt="" />
            <h3>{l.title}</h3>
  ...
  return (
    <div>
        ...
        <div id="inputs">
            <form onSubmit={changeHandler1}>
                <div class="mb-3">
                    <input type="date" onChange={(e)=>clickHandler(e)} name='title' placeholder='Date' class="form-control" id="exampleInputName1" aria-describedby="namelHelp"/>
                </div>
                <div class="mb-3">
                    <input type="name" onChange={(e)=>clickHandler(e)} name='image' placeholder='Img URL' class="form-control" id="exampleInputname1" aria-describedby="emailHelp"/>
                </div>
                <button type="submit" class="btn btn-primary">Submit</button>
            </form>
        </div>
