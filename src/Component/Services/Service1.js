  ...
  return (
    <main>
      <div id="nav">
        ...
        <div id="para">
            <p>Welcome to the Tradefisher Equity Market Services to get Equity or Cash Market tips on technical basis, in this segment we gives only Intraday or BTST positions, we gives daily 3-4 calls in this segment, Tradefisher will give all calls on technical basis after anyalsis on charts through experence team of Tradefisher.</p>
          ...
          <div id="fadd">
            ...
            <div className="address">
              <h2>Gujrat Office</h2>
                ...
                <p>Address: Trade Fisher Research Private Limited, Adajan Colony, Sector A, AK Road Gujrat 395008</p>
                <p>Email: support@tradefisher.in | © Copyright 2021 Trade Fisher Research Pvt. Ltd. All Rights Reserved.</p>
                {/* <p>Principal Officer: Manish Goel, Email: manish@equentis.com, +91 22 61013800</p> */}
            </div>
            <div className="address">
