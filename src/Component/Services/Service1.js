  ...
  return (
    <main>
      <div id="nav">
        ...
        <div id="para">
            <p>Welcome to the Masteresearch Equity Market Services to get Equity or Cash Market tips on technical basis, in this segment we gives only Intraday or BTST positions, we gives daily 3-4 calls in this segment, Mastersearch will give all calls on technical basis after anyalsis on charts through experence team of Masteresearch.</p>
