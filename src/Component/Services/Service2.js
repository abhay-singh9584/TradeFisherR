...
function Contact() {
  ...
  return (
    <main>
        ...
        <section id='top'>
            <p>Commodity <br /> Market</p>
        </section>
        <div id="para">
            <p>Welcome to the Tradefisher Commodity Market Services to get Commodity or Gold Silver CurdeOil Market tips on technical basis, in this segment we gives only Intraday or BTST or STBT positions, we gives daily 3-4 calls in this segment, Tradefisher will give all calls on technical basis after anyalsis on charts through experence team of Tradefisher.</p>
