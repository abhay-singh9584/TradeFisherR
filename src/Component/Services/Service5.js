...
function Contact() {
  ...
  return (
    <main>
        ...
        <div id="para">
            <p>Welcome to the Tradefisher Combo Services to get Combo or Gold Silver CurdeOil Market tips on technical basis, in this segment we gives only Intraday or BTST or STBT positions, we gives daily 3-4 calls in this segment, Tradefisher will give all calls on technical basis after anyalsis on charts through experence team of Tradefisher.</p>
            ...
            <div id="kpoint">
                ...
                <div id="pricing">
                    ...
                    <div className="all">
                        ...
                        <h3>All Equity Segment or <br /> All Commodity Segment</h3>
                        <br />
                        <h1>INR 69,999</h1>
                        <p>per month</p>
                    </div>
        ...
        <div id="ll">
          ...
          <div id="fadd">
            <div className="address">
              <h2>Gurgaon Office</h2>
                <p>Address: Trade Fisher Research Private Limited, Marathon Futurex, A-603 6th Floor, Mafatlal Mills Compound, N M Joshi Marg, Lower Parel East,South West Delhi, Gurgaon 110037</p>
          ...
          <br />
          <div id="leftnav">
            <img src="https://firebasestorage.googleapis.com/v0/b/tradefisher-29821.appspot.com/o/Trade_Fisher.png?alt=media&token=4a557974-246f-4f49-8e0d-19e6b4978901" height={50} alt="none"/>
            <div id="llll">
